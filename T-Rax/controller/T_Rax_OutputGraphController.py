...
class TRaxOutputGraphController(object):
    ...
    def plot_temperature_series(self, time_step, ds_temperature, ds_temperature_errors,
        ...
        self.view.plot_series(x, ds_temperature, ds_temperature_errors, colors.DOWNSTREAM_COLOR_NORM, 'Downstream')
        self.view.plot_series(x ,us_temperature, us_temperature_errors, colors.UPSTREAM_COLOR_NORM, 'Upstream')
        ...
        self.view.combined_temperature_lbl.setText('{T:1.0f} +- {T_err:1.0f} K'.format(T=combined_temperature_avg,
