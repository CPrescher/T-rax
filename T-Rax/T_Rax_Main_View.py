...
class TraxMainWindow(wx.Frame):
    ...
    def create_panels(self):
        ...
        self.control_panel = TraxMainControlPanel(self.main_panel)
...
class TraxMainControlPanel(wx.Panel):
    def __init__(self, parent):
        super(TraxMainControlPanel, self).__init__(parent)
...
class TraxMainGraphPanel(wx.Panel):
    ...
    def plot_img(self, X,Y,data):
        self.image_axes.cla()
        self.image_axes.imshow(data, cmap = 'hot', aspect='auto');
