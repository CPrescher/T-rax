...
#
# Created: Wed Oct 02 10:44:18 2013
...
""))
        ...
        self.label_11 = QtGui.QLabel(self.fitting_roi_box)
        ...
        self.label_12 = QtGui.QLabel(self.fitting_roi_box)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, roi_selector_main_widget):
        ...
        self.fitting_roi_box.setTitle(_translate("roi_selector_main_widget", "Fitting Parameters", None))
