...
class Ui_temperature_control_widget(object):
    def setupUi(self, temperature_control_widget):
        ...
        temperature_control_widget.resize(269, 425)
...
" }  "))
        ...
        self.radioButton = QtGui.QRadioButton(self.upstream_calib_box)
        self.radioButton.setObjectName(_fromUtf8("radioButton"))
        self.gridLayout_3.addWidget(self.radioButton, 2, 1, 1, 1)
        self.label_8 = QtGui.QLabel(self.upstream_calib_box)
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.gridLayout_3.addWidget(self.label_8, 4, 1, 1, 1)
        self.radioButton_2 = QtGui.QRadioButton(self.upstream_calib_box)
        self.radioButton_2.setObjectName(_fromUtf8("radioButton_2"))
        self.gridLayout_3.addWidget(self.radioButton_2, 3, 1, 1, 1)
        self.horizontalLayout_5 = QtGui.QHBoxLayout()
        self.horizontalLayout_5.setObjectName(_fromUtf8("horizontalLayout_5"))
        self.lineEdit_3 = QtGui.QLineEdit(self.upstream_calib_box)
        ...
        self.pushButton_6 = QtGui.QPushButton(self.upstream_calib_box)
        ...
        self.radioButton_3 = QtGui.QRadioButton(self.downstream_calib_box)
        self.radioButton_3.setObjectName(_fromUtf8("radioButton_3"))
        self.gridLayout_4.addWidget(self.radioButton_3, 2, 1, 1, 1)
        self.label_10 = QtGui.QLabel(self.downstream_calib_box)
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.gridLayout_4.addWidget(self.label_10, 4, 1, 1, 1)
        self.radioButton_4 = QtGui.QRadioButton(self.downstream_calib_box)
        self.radioButton_4.setObjectName(_fromUtf8("radioButton_4"))
        self.gridLayout_4.addWidget(self.radioButton_4, 3, 1, 1, 1)
        self.horizontalLayout_7 = QtGui.QHBoxLayout()
        self.horizontalLayout_7.setObjectName(_fromUtf8("horizontalLayout_7"))
        self.lineEdit_4 = QtGui.QLineEdit(self.downstream_calib_box)
        ...
        self.pushButton_8 = QtGui.QPushButton(self.downstream_calib_box)
    ...
    def retranslateUi(self, temperature_control_widget):
        ...
        self.label_8.setText(_translate("temperature_control_widget", "15A Lamp", None))
