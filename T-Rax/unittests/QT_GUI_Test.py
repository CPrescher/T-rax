...
class Test_QT_GUI_Test(unittest.TestCase):
    ...
    def test_temperature_load_exp_data(self):
        ...
        self.assertEqual(str(self.temperature_controller.main_view.temperature_control_widget.exp_folder_name_lbl.text()),
    ...
    def test_temperature_calibration_tab(self):
        ...
        self.assertEqual(self.temperature_controller.main_view.temperature_control_widget.ds_calib_filename_lbl.text(), 'dn_15.SPE')
        self.assertEqual(self.temperature_controller.main_view.temperature_control_widget.us_calib_filename_lbl.text(), 'up_15.SPE')
        ...
        self.assertEqual(self.temperature_controller.main_view.temperature_control_widget.ds_etalon_lbl.text(),'15A_lamp.txt')
        self.assertEqual(self.temperature_controller.main_view.temperature_control_widget.us_etalon_lbl.text(),'15A_lamp.txt')
    ...
    def test_settings(self):
        ...
        self.temperature_controller.load_settings_btn_click('unittest files/setting1.trs')
        self.assertEqual(str(self.temperature_controller.main_view.temperature_control_widget.ds_calib_filename_lbl.text()),
                        'Select File...')
