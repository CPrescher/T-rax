...
class Test_T_Rax_Data_Test(unittest.TestCase):
    ...
    def test_settings(self):
        ...
        self.assertEqual(initial_settings.ds_temperature,2000)
        self.assertEqual(initial_settings.us_temperature,2000)
        ...
        self.assertEqual(initial_settings.ds_modus,1)
        self.assertEqual(initial_settings.us_modus,1)
