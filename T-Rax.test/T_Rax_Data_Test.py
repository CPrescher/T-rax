...
import unittest
from data.T_Rax_TemperatureData import TraxTemperatureData, ROI, ROIData, ROIDataManager
...
class Test_T_Rax_Data_Test(unittest.TestCase):
    ...
    def test_settings(self):
        ...
        data.load_ds_calibration_data('unittests/unittest files/dn_15.SPE')
        data.load_us_calibration_data('unittests/unittest files/up_15.SPE')
        data.load_exp_file('unittests/unittest files/SPE_v2_PIXIS.SPE')
        data.set_ds_calibration_temp(1500)
        data.set_ds_calibration_modus(0)
