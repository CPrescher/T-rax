...
from TRaxROISelector.T_Rax_ROI_Controller import TRaxROIController
import wx
...
class TraxMainViewController(object):
    ...
    def set_ds_modus_etalon(self, event):
        if self.data.ds_calibration_parameter.etalon_spectrum_func == None:
    ...
    def set_us_modus_etalon(self, event):
        if self.data.us_calibration_parameter.etalon_spectrum_func == None:
